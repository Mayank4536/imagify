...
const Header = () => {
  ...
  //Here We create a function Generate Images
    ...
    <motion.div className=' flex flex-col justify-center items-center text-center my-20'
     ...
     >
      ...
      <motion.p className=' text-center max-w-xl mx-auto mt-5'
        ...
        >
        Unlease your creativity with AI. Turn your imagination into visual art in seconds - just type, and watch the magic happen.
      </motion.p>
