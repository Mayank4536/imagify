    ...
    >
      ...
      <div className=' flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full'>
        <p onClick={()=>{setIsImageLoaded(false)}}
          className=' bg-transparent border border-zinc-900 text-black px-8 py-3 cursor-pointer font-medium'>Generate Another
        </p>
        <a href={image} download className=' bg-zinc-900 px-10 py-3 cursor-pointer'>Download</a>
      </div>
      }
